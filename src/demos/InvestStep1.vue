  ...
  export default {
    ...
    data () {
      return {
        ...
        planName: '',
        dream: '',
        dream_money: Number(this.$route.query.money),
        position: 'default',
        toastText: '',
    ...
    methods: {
          ...
          if (res.data.retCode === '0') {
            ...
            this.$router.push({
              ...
              query: {
                ...
                nextTradeDate: res.data.data.nextTradeDate,
                term: this.term,
                zdate: this.endDate,
                cycle: this.cycle[0],
      ...
      getAIModel () {
        ...
        this.term = term
        let freelv = (1 + day / 365.25 * 6 / 5) / 100
      ...
      getParams () {
        ...
        this.planName = this.$route.query.dream
        // this.dream = this.$route.query.dream
        this.dream_money = Number(this.$route.query.money)
        for (let i = 1; i <= 28; i++) {
          this.listc[0].push(i + '号')
        }
      },
